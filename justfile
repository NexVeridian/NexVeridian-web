...
process_single_model hf_url:
    ...
    rclone copyto -P --fast-list --copy-links --transfers 32 --multi-thread-streams 32 --buffer-size=10Gi --multi-thread-write-buffer-size=1Gi \
    ...
    rclone copyto -P -u --fast-list --copy-links --transfers 32 --multi-thread-streams 32 --buffer-size=10Gi --multi-thread-write-buffer-size=1Gi \
        "$HOME/.cache/huggingface/hub/$model_cache_name" \
        "tower:hf-cache/huggingface/hub/$model_cache_name"
